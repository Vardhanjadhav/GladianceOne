...
public class AirConditioningFragment extends Fragment implements CircleSeekBar.OnSeekBarChangedListener {
...
//        change = view.findViewById(R.id.change_button);
        circleSeekBar.setProgressDisplayAndInvalidate(16);
